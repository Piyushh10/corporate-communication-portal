...
const users = [
  { id: 'alice', name: 'Alice Johnson', status: 'online', avatarUrl: '' },
  { id: 'bob', name: 'Bob Smith', status: 'offline', avatarUrl: '' },
  { id: 'carol', name: 'Carol Davies', status: 'away', avatarUrl: '' },
  { id: 'dave', name: 'Dave Wilson', status: 'dnd', avatarUrl: '' },
];
